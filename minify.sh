...
cat languages/language.js site/mapa.js site/estudio.js site/partgen.js site/tabgen.js tab2part/t2p_parser.js part2tab/p2t_parser.js > tmp/site.js

cat css/mapa.css css/studio.css > tmp/site.css

cp tmp/site.css site_$1.css
cp tmp/site.js site_$1.js
